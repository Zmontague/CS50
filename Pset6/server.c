...
{   
    char* ltype = NULL;
    char dot = '.';
    const char* fp = strchr(path, dot);
   
  
   
    if (strcasecmp(".css", fp) == 0)
    {   
        ltype = "text/css";
        return ltype;
    }
    else if (strcasecmp(".html", fp) == 0)
    {
        ltype = "text/html";
        return ltype;
    }
    else if (strcasecmp(".gif", fp) == 0)
    {
        ltype = "image/gif";
        return ltype;
    }
    else if (strcasecmp(".ico", fp) == 0)
    {
        ltype = "image/x-icon";
        return ltype;
    }
    else if (strcasecmp(".jpg", fp) == 0)
    {
        ltype = "image/jpeg";
        return ltype;
    }
    else if (strcasecmp(".js", fp) == 0)
    {
        ltype = "text/javascript";
        return ltype;
    }
    else if (strcasecmp(".png", fp) == 0)
    {
        ltype = "image/png";
        return ltype;
    }
    else if (strcasecmp(".php", fp) == 0) 
    {
        ltype = "text/x-php";
        return ltype;
    } 
...
{
  //pointer to be used for extraction STRSEP -- WILL PROBABLY FIX IT. 
  char* ptr = NULL;
  //method pointer
