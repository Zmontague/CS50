...
int main(int argc, char* argv[])
{
    ...
    if (argc != 4)
    {
        printf("Usage: resize dimension infile outfile\n");
        return 1;
    }
    ...
    {
        printf("Please pick an int between 1 and 100!\n");
        return 1;
    }
    ...
    bi_r.biWidth  = bi.biWidth * dimension;
    bi_r.biHeight = bi.biHeight * dimension;
    
    //determine the padding differences
    ...
    {
        // Read each scanline dimension times
        ...
        {  
            ...
            for (int k = 0; k < bi.biWidth; k++)
            {
                ...
                //write RGB triple to outfile, multiplied by dimension
